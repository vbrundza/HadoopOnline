...
public class ExampleDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      pgd.addClass("monitor", MonitorClient.class,
                   "A map/reduce monitoring program.");
      pgd.addClass("avgtemp", AverageTemperature.class,
    		  	   "A map/reduce program that computes the average temperature of the year, given in a specially formated input files");
      pgd.addClass("wikistats", WikiStats.class,
                   "A map/reduce program that computes statistics on wikipedia click data.");
